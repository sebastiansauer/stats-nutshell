...
url <- "https://raw.githubusercontent.com/sebastiansauer/Lehre/main/Archiv/yacsdas/yacsdas-vis.md"
...
url <- "https://raw.githubusercontent.com/sebastiansauer/Lehre/main/Archiv/yacsdas/yacsdas-EDA.md"
childtext <- readLines(url)
cat(childtext, sep="\n")
```
...
url <- "https://raw.githubusercontent.com/sebastiansauer/Lehre/main/Archiv/yacsdas/yacsdas-lm.md"
childtext <- readLines(url)
cat(childtext, sep="\n")
```
...
url <- "https://raw.githubusercontent.com/sebastiansauer/Lehre/main/Archiv/yacsdas/yacsdas-tidymodels.md"
childtext <- readLines(url)
cat(childtext, sep="\n")
```
...
Check-out the references pointed out in this course, see @sec-references.
