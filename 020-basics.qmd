...
A bit more advanced, but it's a nice data set, 
try the Palmer Penguins data set:
...
{{< downloadthis data/penguins.csv dname="penguins" label="Download the penguins data (CSV)" icon="database-fill-down" type="info" >}}
...
{{< downloadthis data/mariokart.csv dname="mariokart" label = "Download the Mariokart data set (CSV)" icon="database-fill-down" type="info" >}} {{< downloadthis data/mariokart.xlsx dname="mariokart.xlsx" label = "Download the Mariokart data set XLSX" > icon="database-fill-down" type="info"}}
