...
{{< downloadthis data/mariokart.csv dname="mariokart" label = "Download the Mariokart data set (CSV)" icon="database-fill-down" type="info" >}} {{< downloadthis data/mariokart.xlsx dname="mariokart" label = "Download the Mariokart data set XLSX" > icon="database-fill-down" type="info" >}}
