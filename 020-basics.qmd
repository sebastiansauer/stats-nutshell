...
{{< downloadthis data/mariokart.csv dname="mariokart" label = "Download the Mariokart data set (CSV)" >}} {{< downloadthis data/mariokart.xlsx dname="mariokart.xlsx" label = "Download the Mariokart data set XLSX" >}}
